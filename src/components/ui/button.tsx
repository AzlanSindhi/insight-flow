  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        warm: "bg-warm text-warm-foreground shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]",
        sage: "bg-sage text-sage-foreground shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]",
        hero: "bg-foreground text-background rounded-full shadow-lg hover:shadow-xl hover:scale-[1.03] active:scale-[0.98] text-base font-medium px-8 py-4",
      },
      size: {
